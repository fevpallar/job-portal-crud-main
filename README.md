...
CR-U stands for "CReate *minus* the Update"operations. It is a quick-mini project to demonstrate common hypothetical Create & Update activities on such online job search site. The project is deployed in a single node Kubernate cluster.
